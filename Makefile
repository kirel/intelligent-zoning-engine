...
data/ESB2012_WGS84_EWR2012-12.geojson:
	...
	ogr2ogr -t_srs EPSG:3857 -f geoJSON $@ data/ESB2012_WGS84_EWR2012-12/ESB2012_WGS84_EWR2012-12.shp
...
data/LOR_SHP_EPSG_25833.geojson:
	...
	ogr2ogr -s_srs EPSG:25833 -t_srs EPSG:3857 -f geoJSON $@ data/LOR_SHP_EPSG_25833/Planungsraum.shp
	rm -rf data/LOR_SHP_EPSG_25833
LOR: data/LOR_SHP_EPSG_25833.geojson

data/re_alkis_tatsaechlichenutzungflaechen.geojson:
	ogr2ogr -s_srs EPSG:25833 -t_srs EPSG:3857 -f geoJSON $@ WFS:"http://fbinter.stadt-berlin.de/fb/wfs/geometry/senstadt/re_alkis_tatsaechlichenutzungflaechen" fis:re_alkis_tatsaechlichenutzungflaechen
...
data/re_einwohnerdichte2015.geojson:
	ogr2ogr -s_srs EPSG:25833 -t_srs EPSG:3857 -f geoJSON $@ WFS:"http://fbinter.stadt-berlin.de/fb/wfs/geometry/senstadt/re_einwohnerdichte2015" fis:re_einwohnerdichte2015
